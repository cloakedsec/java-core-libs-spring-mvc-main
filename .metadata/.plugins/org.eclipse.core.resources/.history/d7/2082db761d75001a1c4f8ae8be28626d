...
//		driver.findElement(By.id("states-autocomplete")).sendKeys("hello");
		driver.findElement(By.id("5a9c9efae4b04378c0c9992e")).clear();
		driver.findElement(By.id("5a9c9efae4b04378c0c9992e")).sendKeys("Miami");
		driver.findElement(By.id("5a9c9f34e4b0a62b51d062ed")).clear();
		driver.findElement(By.id("5a9c9f34e4b0a62b51d062ed")).sendKeys("Instanbul");
		driver.findElement(By.id("5a9c9f63e4b0a62b51d062ee")).clear();
		driver.findElement(By.id("5a9c9f63e4b0a62b51d062ee")).sendKeys("GBP");
		driver.findElement(By.id("5a9c9f8de4b00687d35733f0")).clear();
